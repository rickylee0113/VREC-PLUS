...
const CourtMap: React.FC<CourtMapProps> = ({ 
  ...
  const getStrokeColor = (result?: ResultType, skill?: SkillType) => {
      if (skill === 'Receive') return '#eab308'; // Yellow-500 for Receive
      ...
      >
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none overflow-visible z-20">
            <defs>
                ...
                <marker id="arrowhead-receive" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto">
            ...
            {trajectories && trajectories.map((traj, idx) => {
                ...
                if (traj.skill === 'Receive') marker = 'url(#arrowhead-receive)';
                else if (traj.result === 'Point') marker = 'url(#arrowhead-point)';
